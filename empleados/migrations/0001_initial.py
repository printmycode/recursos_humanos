    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifieddate', models.DateTimeField(blank=True, null=True)),
                ('businessentityid_departmentid_shiftid_startdate_enddate_modifie', models.CharField(blank=True, db_column='BusinessEntityID;DepartmentID;ShiftID;StartDate;EndDate;Modifie', max_length=64, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Employee',
            fields=[
                ('businessentityid', models.OneToOneField(db_column='businessentityid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='empleados.person')),
