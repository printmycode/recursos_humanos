...
class Employee(models.Model):
    ...
    def __str__(self):
        return f"{self.businessentityid} - {self.loginid}"
...
class Employeedepartmenthistory(models.Model):
    ...
    modifieddate = models.DateTimeField(blank=True, null=True)
    businessentityid_departmentid_shiftid_startdate_enddate_modifie = models.CharField(db_column='BusinessEntityID;DepartmentID;ShiftID;StartDate;EndDate;Modifie', max_length=64, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    def __str__(self):
        return f"{self.businessentityid} - {self.departmentid}"
...
class Employeepayhistory(models.Model):
    ...
    def __str__(self):
        return f"{self.businessentityid} - {self.ratechangedate}"
...
class Person(models.Model):
    ...
    def __str__(self):
        return f"{self.businessentityid} - {self.firstname} {self.lastname}"
